...
> **Kit-owned file.** This file is managed by the kit and is overwritten
> verbatim by `init.sh --update`. To customize these rules, edit the kit repo
> and redeploy via `--update` — do not edit this file directly inside a
> project.
...
- **MUST review**: auth / authz / session; payment / billing / money;
  data migration / schema; anything in the project's CLAUDE.md
...
- Touches anything in the project's CLAUDE.md "Project-specific constraints"
  section.
