...
| [`ARCHITECTURE.md`](ARCHITECTURE.md) | 想深入 | 為什麼這樣設計、v1→v4.1 完整取捨、四維 isolation |
...
*版本:**v4.1**(判斷層採納,fable-soul MIT 蒸餾)。完整版本演進見
[`ARCHITECTURE.md §二`](ARCHITECTURE.md)。*
